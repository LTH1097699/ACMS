...
@section('content-header')
    <h1>
        {{ trans('quanlychung::hopdongs.title.create hopdong') }}
    </h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('dashboard.index') }}"><i class="fa fa-dashboard"></i> {{ trans('core::core.breadcrumb.home') }}</a></li>
        <li><a href="{{ route('admin.quanlychung.hopdong.index') }}">{{ trans('quanlychung::hopdongs.title.hopdongs') }}</a></li>
        <li class="active">{{ trans('quanlychung::hopdongs.title.create hopdong') }}</li>
    </ol>
@stop

@section('content')
    {!! Form::open(['route' => ['admin.quanlychung.hopdong.store'], 'method' => 'post']) !!}
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="tab-content">
                    ...
                    @foreach (LaravelLocalization::getSupportedLocales() as $locale => $language)
                        ...
                        <div class="tab-pane {{ locale() == $locale ? 'active' : '' }}" id="tab_{{ $i }}">
                            @include('quanlychung::admin.hopdongs.partials.create-fields', ['lang' => $locale])
                        </div>
                    @endforeach
