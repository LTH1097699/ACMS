...
@section('content-header')
    <h1>
        {{ trans('bangchamcong::bangchamcongs.title.edit bangchamcong') }}
    </h1>
    <ol class="breadcrumb">
        ...
        <li class="active">{{ trans('bangchamcong::bangchamcongs.title.edit bangchamcong') }}</li>
    </ol>
@stop

@section('content')
    {!! Form::open(['route' => ['admin.bangchamcong.bangchamcong.update', $bangchamcong->id], 'method' => 'put']) !!}
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="tab-content">
                    ...
                    @foreach (LaravelLocalization::getSupportedLocales() as $locale => $language)
                        ...
                        <div class="tab-pane {{ locale() == $locale ? 'active' : '' }}" id="tab_{{ $i }}">
                            @include('bangchamcong::admin.bangchamcongs.partials.edit-fields', ['lang' => $locale])
                        </div>
                    @endforeach
